"""Run Ground 1-6 in monocular mode with refined JIST and boundary 0.05."""
        ...
        [
            IncludeLaunchDescription(
                ...
                launch_arguments={
                    "vio_mode": "mono",
                    "vio_dataset_name": (
                        "GrAcoGndMonoXfeatJistDsNoAugNoLgBoundary005"
                    ),
