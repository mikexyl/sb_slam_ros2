"""Run Ground 2–5 with JIST 0.8, LightGlue, and dynamic sequences."""
...
def _timestamped_recording_id():
    ...
    return f"graco_g2345_jist08_ds_noaug_lg_{timestamp}"
...
def _timestamped_output_path():
    ...
    run_name = (
        "jist-ds-noaug-lg-boundary0.1-consecutive-disabled-"
...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "vio_dataset_name",
                default_value="GrAcoGndStereoXfeatJistDsNoAugLg",
                description=(
            ...
            DeclareLaunchArgument(
                "rerun_application_id",
                default_value="graco_g2345_jist08_ds_noaug_lg",
            ),
            DeclareLaunchArgument(
                "rerun_recording_id",
