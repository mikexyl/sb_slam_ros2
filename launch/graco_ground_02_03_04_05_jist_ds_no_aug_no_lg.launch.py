"""Run Ground 2–5 with JIST 0.8 and ROS1-matched VILIB-only tracking."""
...
def _timestamped_recording_id():
    ...
    return f"graco_g2345_jist08_ds_noaug_nolg_{timestamp}"
...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "rerun_application_id",
                default_value="graco_g2345_jist08_ds_noaug_nolg",
            ),
            DeclareLaunchArgument(
                "rerun_recording_id",
