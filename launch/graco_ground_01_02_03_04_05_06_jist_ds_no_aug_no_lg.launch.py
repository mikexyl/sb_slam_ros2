"""Run Ground 1–6 with JIST 0.8 and ROS1-matched VILIB-only tracking."""
...
def _timestamped_recording_id():
    ...
    return f"graco_g123456_jist08_ds_noaug_nolg_{timestamp}"
...
def _timestamped_output_path():
    ...
    return str(workspace_root / "src" / "code-logs" / "g123456" / run_name)
...
def generate_launch_description():
    base_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            "ground_01_bag_path": LaunchConfiguration("ground_01_bag_path"),
            ...
            "ground_06_bag_path": LaunchConfiguration("ground_06_bag_path"),
            ...
            "models.stereo_depth": LaunchConfiguration(
                "models.stereo_depth"
            ),
    ...
    return LaunchDescription(
        [
            DeclareLaunchArgument(
                "active_robot_ids", default_value="0,1,2,3,4,5"
            ),
            DeclareLaunchArgument(
                "robot_names_file",
            ...
            DeclareLaunchArgument(
                "rerun_application_id",
                default_value="graco_g123456_jist08_ds_noaug_nolg",
            ),
            DeclareLaunchArgument(
                "rerun_recording_id",
