"""Run the comparable A5678 JIST no-augmentation/fixed-five ablation."""
...
def _run_identity():
    ...
    workspace_root = Path(os.environ.get("SB_SLAM_ROS2_WS", os.getcwd()))
    run_name = (
        "jist-noaug-lgrematch-fixed5-jist0.7-diversity-off-"
        "distlocal90-sim3-"
        f"{timestamp}"
    )
    output_path = workspace_root / "src" / "code-logs" / "a5678" / run_name
    recording_id = f"graco_a5678_jist_noaug_lg_fixed5_{timestamp}"
...
def generate_launch_description():
    ...
    reference_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            "bag_rate": "1.0",
            "vio_dataset_name": "GrAcoStereoXfeatJistNoAugFixed5",
            ...
            "rerun_application_id": "graco_a5678_jist_noaug_lg_fixed5",
