...
tracking. The newer loop-closure path uses no sequence-descriptor diversity
gate, a 0.1 sequence boundary, and distributed LightGlue verification after
refinement.
"""
...
def generate_launch_description():
    ...
    run_name = (
        "jist-ds-noaug-lg-rematch-window100-realsense-mono-boundary0.1-"
        "consecutive-disabled-jist0.8-seqdiv-off-distlocal90-sim3-"
        "framerefine-argmax-"
        f"{timestamp}"
    )
    output_path = (
    ...
    recording_id = (
        "m2dgr_gate123_jist08_rsmono_lg_window100_framerefine_"
        f"{timestamp}"
    )
    ...
    base_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            "rerun_application_id": (
                "m2dgr_gate123_jist08_rsmono_lg_window100_framerefine"
            ),
